...
<h2 id="Scroll-per-page"><a href="#Scroll-per-page" class="headerlink" title="Scroll per page"></a>Scroll per page</h2><p>Instead of scrolling on a per item basis, the carousel will scroll the configured <a href="/vue-carousel/api#perPage">perPage</a> or <a href="/vue-carousel/api#perPageCustom">perPageCustom</a> with each movement.</p>

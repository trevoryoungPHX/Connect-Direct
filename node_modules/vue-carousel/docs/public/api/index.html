...
<html lang="en">
    <head>
        ...
        <meta property="og:title" content="API - Vue Carousel">
        ...
        <meta name="twitter:title" content="API - Vue Carousel">
...
<li><a href="/vue-carousel/api" class="nav-link current">API</a></li>
...
<div class="content  ">
    ...
    <h2 id="Global-config"><a href="#Global-config" class="headerlink" title="Global config"></a>Global config</h2><h3 id="autoplay"><a href="#autoplay" class="headerlink" title="autoplay"></a>autoplay</h3><p>Flag to enable autoplay</p>
<ul>
...
<figure class="highlight html"><table><tr><td class="gutter"><pre><div class="line">1</div></pre></td><td class="code"><pre><div class="line"><span class="tag">&lt;<span class="name">carousel</span> <span class="attr">:perPageCustom</span>=<span class="string">"[[768, 3], [1024, 4]]"</span>&gt;</span></div></pre></td></tr></table></figure>
...
<h3 id="speed"><a href="#speed" class="headerlink" title="speed"></a>speed</h3><p>Size of each pagination dot. Pixel values are accepted.</p>
<ul>
<li><strong>Type</strong> <code>Number</code></li>
...
<li><strong>Default</strong>: <code>10</code></li>
    ...
    <div class="footer">
      ...
      <a href="https://github.com/SSENSE/vue-carousel/blob/master/docs/source/api/index.md" target="_blank">
